...
public class ComponentClientException extends PrairieException {
    ...
    public ComponentClientException(String message) {
        super(message);
    }

    public ComponentClientException(String message, Throwable cause) {
        super(message, cause);
    }

    public ComponentClientException(Throwable cause) {
        super(cause);
    }
}
